...
pub enum ListStoreProductImagesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreProductImagesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreProductImagesResponseLinksItemMethod {
...
impl fmt::Display for ListStoreProductImagesResponseLinksItemMethod {
