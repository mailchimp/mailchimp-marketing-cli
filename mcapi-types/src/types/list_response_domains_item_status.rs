...
pub enum ListResponseDomainsItemStatus {
...
impl Serialize for ListResponseDomainsItemStatus {
...
impl<'de> Deserialize<'de> for ListResponseDomainsItemStatus {
...
impl fmt::Display for ListResponseDomainsItemStatus {
