...
pub enum ListFeedbackResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFeedbackResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFeedbackResponseLinksItemMethod {
...
impl fmt::Display for ListFeedbackResponseLinksItemMethod {
