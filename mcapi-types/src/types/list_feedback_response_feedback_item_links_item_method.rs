...
pub enum ListFeedbackResponseFeedbackItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFeedbackResponseFeedbackItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFeedbackResponseFeedbackItemLinksItemMethod {
...
impl fmt::Display for ListFeedbackResponseFeedbackItemLinksItemMethod {
