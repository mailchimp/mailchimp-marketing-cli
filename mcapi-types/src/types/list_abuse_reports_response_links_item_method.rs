...
pub enum ListAbuseReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAbuseReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAbuseReportsResponseLinksItemMethod {
...
impl fmt::Display for ListAbuseReportsResponseLinksItemMethod {
