...
pub enum ListResponseExportsItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListResponseExportsItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListResponseExportsItemLinksItemMethod {
...
impl fmt::Display for ListResponseExportsItemLinksItemMethod {
