...
pub enum GetSurveyResponsResponseContactStatus {
    Subscribed,
    Unsubscribed,
    NonSubscribed,
    Cleaned,
...
impl Serialize for GetSurveyResponsResponseContactStatus {
...
impl<'de> Deserialize<'de> for GetSurveyResponsResponseContactStatus {
...
impl fmt::Display for GetSurveyResponsResponseContactStatus {
