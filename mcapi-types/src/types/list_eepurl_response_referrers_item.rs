...
pub struct ListEepurlResponseReferrersItem {
...
impl ListEepurlResponseReferrersItem {
    pub fn builder() -> ListEepurlResponseReferrersItemBuilder {
        <ListEepurlResponseReferrersItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListEepurlResponseReferrersItemBuilder {
    clicks: Option<i64>,
...
impl ListEepurlResponseReferrersItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListEepurlResponseReferrersItem`].
    pub fn build(self) -> Result<ListEepurlResponseReferrersItem, BuildError> {
        Ok(ListEepurlResponseReferrersItem {
            clicks: self.clicks,
