...
impl UpdateSurveyRequest {
    pub fn builder() -> UpdateSurveyRequestBuilder {
        <UpdateSurveyRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateSurveyRequestBuilder {
    title: Option<String>,
    is_piped_to_inbox: Option<bool>,
    sections: Option<Vec<SurveySectionRequest>>,
}

impl UpdateSurveyRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateSurveyRequest`].
    pub fn build(self) -> Result<UpdateSurveyRequest, BuildError> {
        Ok(UpdateSurveyRequest {
            title: self.title,
