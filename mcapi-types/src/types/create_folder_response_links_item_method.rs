...
pub enum CreateFolderResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateFolderResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateFolderResponseLinksItemMethod {
...
impl fmt::Display for CreateFolderResponseLinksItemMethod {
