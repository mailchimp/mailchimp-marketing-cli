...
pub enum ListLocationsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListLocationsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListLocationsResponseLinksItemMethod {
...
impl fmt::Display for ListLocationsResponseLinksItemMethod {
