...
pub enum BatchAddOrRemoveMembersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for BatchAddOrRemoveMembersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for BatchAddOrRemoveMembersResponseLinksItemMethod {
...
impl fmt::Display for BatchAddOrRemoveMembersResponseLinksItemMethod {
