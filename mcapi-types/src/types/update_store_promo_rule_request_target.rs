...
pub enum UpdateStorePromoRuleRequestTarget {
    PerItem,
    Total,
    Shipping,
...
impl Serialize for UpdateStorePromoRuleRequestTarget {
...
impl<'de> Deserialize<'de> for UpdateStorePromoRuleRequestTarget {
...
impl fmt::Display for UpdateStorePromoRuleRequestTarget {
