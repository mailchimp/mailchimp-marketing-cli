...
pub struct ListMemberActivityResponseActivityItem {
...
impl ListMemberActivityResponseActivityItem {
    pub fn builder() -> ListMemberActivityResponseActivityItemBuilder {
        <ListMemberActivityResponseActivityItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListMemberActivityResponseActivityItemBuilder {
...
impl ListMemberActivityResponseActivityItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListMemberActivityResponseActivityItem`].
    pub fn build(self) -> Result<ListMemberActivityResponseActivityItem, BuildError> {
        Ok(ListMemberActivityResponseActivityItem {
            action: self.action,
