...
pub enum ListFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFoldersResponseLinksItemMethod {
...
impl fmt::Display for ListFoldersResponseLinksItemMethod {
