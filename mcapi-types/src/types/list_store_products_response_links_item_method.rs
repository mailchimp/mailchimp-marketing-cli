...
pub enum ListStoreProductsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreProductsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreProductsResponseLinksItemMethod {
...
impl fmt::Display for ListStoreProductsResponseLinksItemMethod {
