...
pub enum BatchSubscribeOrUnsubscribeResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for BatchSubscribeOrUnsubscribeResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for BatchSubscribeOrUnsubscribeResponseLinksItemMethod {
...
impl fmt::Display for BatchSubscribeOrUnsubscribeResponseLinksItemMethod {
