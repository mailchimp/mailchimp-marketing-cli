...
pub enum ListResponseAppsItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListResponseAppsItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListResponseAppsItemLinksItemMethod {
...
impl fmt::Display for ListResponseAppsItemLinksItemMethod {
