...
pub enum CreateMemberRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for CreateMemberRequestStatus {
...
impl<'de> Deserialize<'de> for CreateMemberRequestStatus {
...
impl fmt::Display for CreateMemberRequestStatus {
