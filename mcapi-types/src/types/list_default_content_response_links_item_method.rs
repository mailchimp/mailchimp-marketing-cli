...
pub enum ListDefaultContentResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListDefaultContentResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListDefaultContentResponseLinksItemMethod {
...
impl fmt::Display for ListDefaultContentResponseLinksItemMethod {
