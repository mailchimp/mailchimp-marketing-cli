...
pub enum ListMemberTagsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberTagsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberTagsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberTagsResponseLinksItemMethod {
