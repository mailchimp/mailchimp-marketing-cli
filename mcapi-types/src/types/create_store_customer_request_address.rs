...
pub struct CreateStoreCustomerRequestAddress {
...
impl CreateStoreCustomerRequestAddress {
    pub fn builder() -> CreateStoreCustomerRequestAddressBuilder {
        <CreateStoreCustomerRequestAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateStoreCustomerRequestAddressBuilder {
...
impl CreateStoreCustomerRequestAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateStoreCustomerRequestAddress`].
    pub fn build(self) -> Result<CreateStoreCustomerRequestAddress, BuildError> {
        Ok(CreateStoreCustomerRequestAddress {
