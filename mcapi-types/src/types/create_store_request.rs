...
pub struct CreateStoreRequest {
    ...
    pub address: Option<CreateStoreRequestAddress>,
...
impl CreateStoreRequest {
    pub fn builder() -> CreateStoreRequestBuilder {
        <CreateStoreRequestBuilder as Default>::default()
    }
}
...
pub struct CreateStoreRequestBuilder {
    address: Option<CreateStoreRequestAddress>,
...
impl CreateStoreRequestBuilder {
    pub fn address(mut self, value: CreateStoreRequestAddress) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateStoreRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`currency_code`](CreateStoreRequestBuilder::currency_code)
    /// - [`id`](CreateStoreRequestBuilder::id)
    /// - [`list_id`](CreateStoreRequestBuilder::list_id)
    /// - [`name`](CreateStoreRequestBuilder::name)
    pub fn build(self) -> Result<CreateStoreRequest, BuildError> {
