...
impl CreateStoreOrderEcommerceRequestShippingAddressBuilder {
    ...
    pub fn latitude(mut self, value: CreateStoreOrderEcommerceRequestShippingAddressLatitude) -> Self {
        self.latitude = Some(value);
        self
    }

    pub fn longitude(mut self, value: CreateStoreOrderEcommerceRequestShippingAddressLongitude) -> Self {
