...
pub enum ListMemberEventsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberEventsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberEventsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberEventsResponseLinksItemMethod {
