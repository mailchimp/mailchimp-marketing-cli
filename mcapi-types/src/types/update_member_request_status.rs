...
pub enum UpdateMemberRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpdateMemberRequestStatus {
...
impl<'de> Deserialize<'de> for UpdateMemberRequestStatus {
...
impl fmt::Display for UpdateMemberRequestStatus {
