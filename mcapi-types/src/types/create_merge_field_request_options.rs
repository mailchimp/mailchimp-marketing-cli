...
pub struct CreateMergeFieldRequestOptions {
...
impl CreateMergeFieldRequestOptions {
    pub fn builder() -> CreateMergeFieldRequestOptionsBuilder {
        <CreateMergeFieldRequestOptionsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateMergeFieldRequestOptionsBuilder {
...
impl CreateMergeFieldRequestOptionsBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateMergeFieldRequestOptions`].
    pub fn build(self) -> Result<CreateMergeFieldRequestOptions, BuildError> {
        Ok(CreateMergeFieldRequestOptions {
