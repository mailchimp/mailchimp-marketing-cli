...
pub enum CreateActionCreateResendRequestShortcutType {
    ToNonOpeners,
    ToNewSubscribers,
    ToNonClickers,
    ToNonPurchasers,
...
impl Serialize for CreateActionCreateResendRequestShortcutType {
...
impl<'de> Deserialize<'de> for CreateActionCreateResendRequestShortcutType {
...
impl fmt::Display for CreateActionCreateResendRequestShortcutType {
