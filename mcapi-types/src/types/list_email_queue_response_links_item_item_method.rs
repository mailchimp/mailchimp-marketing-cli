...
pub enum ListEmailQueueResponseLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailQueueResponseLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailQueueResponseLinksItemItemMethod {
...
impl fmt::Display for ListEmailQueueResponseLinksItemItemMethod {
