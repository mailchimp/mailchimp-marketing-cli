...
pub enum ListSendChecklistResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSendChecklistResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSendChecklistResponseLinksItemMethod {
...
impl fmt::Display for ListSendChecklistResponseLinksItemMethod {
