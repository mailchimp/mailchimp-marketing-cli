...
pub enum ListDomainPerformanceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListDomainPerformanceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListDomainPerformanceResponseLinksItemMethod {
...
impl fmt::Display for ListDomainPerformanceResponseLinksItemMethod {
