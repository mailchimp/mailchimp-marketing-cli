...
pub struct CreateResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<CreateResponseStatus>,
...
impl CreateResponse {
    pub fn builder() -> CreateResponseBuilder {
        <CreateResponseBuilder as Default>::default()
    }
}
...
pub struct CreateResponseBuilder {
    ...
    status: Option<CreateResponseStatus>,
...
impl CreateResponseBuilder {
    ...
    pub fn status(mut self, value: CreateResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateResponse`].
    pub fn build(self) -> Result<CreateResponse, BuildError> {
        Ok(CreateResponse {
