...
pub enum GetFolderResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetFolderResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetFolderResponseLinksItemMethod {
...
impl fmt::Display for GetFolderResponseLinksItemMethod {
