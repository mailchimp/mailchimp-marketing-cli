...
pub enum ListSentToResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSentToResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSentToResponseLinksItemMethod {
...
impl fmt::Display for ListSentToResponseLinksItemMethod {
