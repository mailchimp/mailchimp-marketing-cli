...
pub enum ListFolderFilesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFolderFilesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFolderFilesResponseLinksItemMethod {
...
impl fmt::Display for ListFolderFilesResponseLinksItemMethod {
