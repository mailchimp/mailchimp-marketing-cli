...
pub enum ListStoreProductVariantsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreProductVariantsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreProductVariantsResponseLinksItemMethod {
...
impl fmt::Display for ListStoreProductVariantsResponseLinksItemMethod {
