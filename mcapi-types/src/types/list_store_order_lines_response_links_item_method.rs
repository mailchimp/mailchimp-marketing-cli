...
pub enum ListStoreOrderLinesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreOrderLinesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreOrderLinesResponseLinksItemMethod {
...
impl fmt::Display for ListStoreOrderLinesResponseLinksItemMethod {
