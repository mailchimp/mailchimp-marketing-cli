...
pub enum ListSubReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSubReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSubReportsResponseLinksItemMethod {
...
impl fmt::Display for ListSubReportsResponseLinksItemMethod {
