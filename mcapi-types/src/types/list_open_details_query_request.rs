...
pub struct ListOpenDetailsQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_field: Option<ListOpenDetailsRequestSortField>,
    /// Determines the order direction for sorted results.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_dir: Option<ListOpenDetailsRequestSortDir>,
...
pub struct ListOpenDetailsQueryRequestBuilder {
    ...
    offset: Option<i64>,
    since: Option<String>,
    sort_field: Option<ListOpenDetailsRequestSortField>,
    sort_dir: Option<ListOpenDetailsRequestSortDir>,
...
impl ListOpenDetailsQueryRequestBuilder {
    ...
    pub fn sort_field(mut self, value: ListOpenDetailsRequestSortField) -> Self {
        self.sort_field = Some(value);
        self
    }

    pub fn sort_dir(mut self, value: ListOpenDetailsRequestSortDir) -> Self {
