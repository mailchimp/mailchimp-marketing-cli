...
pub enum UpdateFolderResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateFolderResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateFolderResponseLinksItemMethod {
...
impl fmt::Display for UpdateFolderResponseLinksItemMethod {
