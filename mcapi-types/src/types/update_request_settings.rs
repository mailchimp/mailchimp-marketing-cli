...
pub struct UpdateRequestSettings {
...
impl UpdateRequestSettings {
    pub fn builder() -> UpdateRequestSettingsBuilder {
        <UpdateRequestSettingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateRequestSettingsBuilder {
...
impl UpdateRequestSettingsBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateRequestSettings`].
    pub fn build(self) -> Result<UpdateRequestSettings, BuildError> {
        Ok(UpdateRequestSettings {
