...
pub enum BatchSubscribeOrUnsubscribeRequestMembersItemStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for BatchSubscribeOrUnsubscribeRequestMembersItemStatus {
...
impl<'de> Deserialize<'de> for BatchSubscribeOrUnsubscribeRequestMembersItemStatus {
...
impl fmt::Display for BatchSubscribeOrUnsubscribeRequestMembersItemStatus {
