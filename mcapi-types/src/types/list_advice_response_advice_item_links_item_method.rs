...
pub enum ListAdviceResponseAdviceItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAdviceResponseAdviceItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAdviceResponseAdviceItemLinksItemMethod {
...
impl fmt::Display for ListAdviceResponseAdviceItemLinksItemMethod {
