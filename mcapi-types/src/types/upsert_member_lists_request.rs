...
impl UpsertMemberListsRequestBuilder {
    ...
    pub fn marketing_permissions(mut self, value: Vec<UpsertMemberListsRequestMarketingPermissionsItem>) -> Self {
        self.marketing_permissions = Some(value);
        self
    }

    pub fn merge_fields(mut self, value: HashMap<String, UpsertMemberListsRequestMergeFieldsValue>) -> Self {
