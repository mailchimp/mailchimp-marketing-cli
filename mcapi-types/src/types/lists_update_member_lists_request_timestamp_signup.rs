...
impl UpdateMemberListsRequestTimestampSignup {
    ...
    pub fn as_update_member_lists_request_timestamp_signup_one(&self) -> Option<&UpdateMemberListsRequestTimestampSignupOne> {
        match self {
    ...
    pub fn into_update_member_lists_request_timestamp_signup_one(self) -> Option<UpdateMemberListsRequestTimestampSignupOne> {
        match self {
                    Self::UpdateMemberListsRequestTimestampSignupOne(value) => Some(value),
                    _ => None,
                }
...
impl fmt::Display for UpdateMemberListsRequestTimestampSignup {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::UpdateMemberListsRequestTimestampSignupOne(value) => write!(f, "{}", serde_json::to_string(value).unwrap_or_else(|_| format!("{:?}", value))),
        }
    }
}
