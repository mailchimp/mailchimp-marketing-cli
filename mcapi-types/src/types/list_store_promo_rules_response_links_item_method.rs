...
pub enum ListStorePromoRulesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStorePromoRulesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStorePromoRulesResponseLinksItemMethod {
...
impl fmt::Display for ListStorePromoRulesResponseLinksItemMethod {
