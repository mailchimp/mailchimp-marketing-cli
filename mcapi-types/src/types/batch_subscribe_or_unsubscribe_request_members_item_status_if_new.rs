...
pub enum BatchSubscribeOrUnsubscribeRequestMembersItemStatusIfNew {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for BatchSubscribeOrUnsubscribeRequestMembersItemStatusIfNew {
...
impl<'de> Deserialize<'de> for BatchSubscribeOrUnsubscribeRequestMembersItemStatusIfNew {
...
impl fmt::Display for BatchSubscribeOrUnsubscribeRequestMembersItemStatusIfNew {
