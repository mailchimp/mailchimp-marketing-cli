...
pub enum UpdateRequestVariateSettingsWinnerCriteria {
    Opens,
    Clicks,
    Manual,
    TotalRevenue,
...
impl Serialize for UpdateRequestVariateSettingsWinnerCriteria {
...
impl<'de> Deserialize<'de> for UpdateRequestVariateSettingsWinnerCriteria {
...
impl fmt::Display for UpdateRequestVariateSettingsWinnerCriteria {
