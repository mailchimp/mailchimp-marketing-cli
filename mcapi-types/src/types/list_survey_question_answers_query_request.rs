...
pub struct ListSurveyQuestionAnswersQueryRequest {
    ...
    pub respondent_familiarity_is: Option<ListSurveyQuestionAnswersRequestRespondentFamiliarityIs>,
}
...
pub struct ListSurveyQuestionAnswersQueryRequestBuilder {
    ...
    respondent_familiarity_is: Option<ListSurveyQuestionAnswersRequestRespondentFamiliarityIs>,
}
...
impl ListSurveyQuestionAnswersQueryRequestBuilder {
    ...
    pub fn respondent_familiarity_is(mut self, value: ListSurveyQuestionAnswersRequestRespondentFamiliarityIs) -> Self {
