...
pub enum UpsertMemberRequestStatusIfNew {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpsertMemberRequestStatusIfNew {
...
impl<'de> Deserialize<'de> for UpsertMemberRequestStatusIfNew {
...
impl fmt::Display for UpsertMemberRequestStatusIfNew {
