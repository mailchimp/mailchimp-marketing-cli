...
pub enum ListRemovedSubscribersResponseLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListRemovedSubscribersResponseLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for ListRemovedSubscribersResponseLinksItemItemMethod {
...
impl fmt::Display for ListRemovedSubscribersResponseLinksItemItemMethod {
