...
pub struct ListResponseDomainsItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListResponseDomainsItemStatus>,
...
impl ListResponseDomainsItem {
    pub fn builder() -> ListResponseDomainsItemBuilder {
        <ListResponseDomainsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListResponseDomainsItemBuilder {
    authenticated: Option<bool>,
    domain: Option<String>,
    is_free_email_provider: Option<bool>,
    status: Option<ListResponseDomainsItemStatus>,
    verification_email: Option<String>,
    verification_sent: Option<DateTime<FixedOffset>>,
    verified: Option<bool>,
}

impl ListResponseDomainsItemBuilder {
    ...
    pub fn status(mut self, value: ListResponseDomainsItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListResponseDomainsItem`].
    pub fn build(self) -> Result<ListResponseDomainsItem, BuildError> {
        Ok(ListResponseDomainsItem {
