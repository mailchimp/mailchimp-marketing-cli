...
pub struct UpdateMergeFieldRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub options: Option<UpdateMergeFieldRequestOptions>,
...
impl UpdateMergeFieldRequest {
    pub fn builder() -> UpdateMergeFieldRequestBuilder {
        <UpdateMergeFieldRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateMergeFieldRequestBuilder {
    default_value: Option<String>,
    display_order: Option<i64>,
    help_text: Option<String>,
    name: Option<String>,
    options: Option<UpdateMergeFieldRequestOptions>,
    public: Option<bool>,
    required: Option<bool>,
    tag: Option<String>,
}

impl UpdateMergeFieldRequestBuilder {
    ...
    pub fn options(mut self, value: UpdateMergeFieldRequestOptions) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateMergeFieldRequest`].
    pub fn build(self) -> Result<UpdateMergeFieldRequest, BuildError> {
        Ok(UpdateMergeFieldRequest {
