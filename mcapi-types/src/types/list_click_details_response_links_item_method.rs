...
pub enum ListClickDetailsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListClickDetailsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListClickDetailsResponseLinksItemMethod {
...
impl fmt::Display for ListClickDetailsResponseLinksItemMethod {
