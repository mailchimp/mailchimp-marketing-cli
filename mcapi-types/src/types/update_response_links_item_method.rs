...
pub enum UpdateResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateResponseLinksItemMethod {
...
impl fmt::Display for UpdateResponseLinksItemMethod {
