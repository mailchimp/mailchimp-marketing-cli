...
pub enum ListMemberGoalsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberGoalsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberGoalsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberGoalsResponseLinksItemMethod {
