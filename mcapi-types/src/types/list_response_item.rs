...
pub struct ListResponseItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub method: Option<ListResponseItemMethod>,
...
impl ListResponseItem {
    pub fn builder() -> ListResponseItemBuilder {
        <ListResponseItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListResponseItemBuilder {
    href: Option<String>,
    method: Option<ListResponseItemMethod>,
    rel: Option<String>,
    schema: Option<String>,
    target_schema: Option<String>,
}

impl ListResponseItemBuilder {
    pub fn href(mut self, value: impl Into<String>) -> Self {
        self.href = Some(value.into());
        self
    }

    pub fn method(mut self, value: ListResponseItemMethod) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListResponseItem`].
    pub fn build(self) -> Result<ListResponseItem, BuildError> {
        Ok(ListResponseItem {
            href: self.href,
            method: self.method,
            rel: self.rel,
