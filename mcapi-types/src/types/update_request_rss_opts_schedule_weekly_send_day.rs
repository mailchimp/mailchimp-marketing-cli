...
pub enum UpdateRequestRssOptsScheduleWeeklySendDay {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for UpdateRequestRssOptsScheduleWeeklySendDay {
...
impl<'de> Deserialize<'de> for UpdateRequestRssOptsScheduleWeeklySendDay {
...
impl fmt::Display for UpdateRequestRssOptsScheduleWeeklySendDay {
