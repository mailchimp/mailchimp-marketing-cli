...
pub enum UpdateStorePromoRuleRequestEndsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for UpdateStorePromoRuleRequestEndsAtOne {
...
impl<'de> Deserialize<'de> for UpdateStorePromoRuleRequestEndsAtOne {
...
impl fmt::Display for UpdateStorePromoRuleRequestEndsAtOne {
