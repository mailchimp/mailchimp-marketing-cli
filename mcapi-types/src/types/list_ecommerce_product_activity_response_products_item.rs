...
pub struct ListEcommerceProductActivityResponseProductsItem {
...
impl ListEcommerceProductActivityResponseProductsItem {
    pub fn builder() -> ListEcommerceProductActivityResponseProductsItemBuilder {
        <ListEcommerceProductActivityResponseProductsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListEcommerceProductActivityResponseProductsItemBuilder {
...
impl ListEcommerceProductActivityResponseProductsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListEcommerceProductActivityResponseProductsItem`].
    pub fn build(self) -> Result<ListEcommerceProductActivityResponseProductsItem, BuildError> {
        Ok(ListEcommerceProductActivityResponseProductsItem {
