...
pub enum ListStoreCartLinesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCartLinesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCartLinesResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCartLinesResponseLinksItemMethod {
