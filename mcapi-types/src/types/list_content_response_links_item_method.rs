...
pub enum ListContentResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListContentResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListContentResponseLinksItemMethod {
...
impl fmt::Display for ListContentResponseLinksItemMethod {
