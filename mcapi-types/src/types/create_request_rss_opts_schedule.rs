...
pub struct CreateRequestRssOptsSchedule {
    /// The days of the week to send a daily RSS Campaign.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub daily_send: Option<CreateRequestRssOptsScheduleDailySend>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub weekly_send_day: Option<CreateRequestRssOptsScheduleWeeklySendDay>,
}

impl CreateRequestRssOptsSchedule {
    pub fn builder() -> CreateRequestRssOptsScheduleBuilder {
        <CreateRequestRssOptsScheduleBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateRequestRssOptsScheduleBuilder {
    daily_send: Option<CreateRequestRssOptsScheduleDailySend>,
    hour: Option<i64>,
    monthly_send_date: Option<f64>,
    weekly_send_day: Option<CreateRequestRssOptsScheduleWeeklySendDay>,
}

impl CreateRequestRssOptsScheduleBuilder {
    pub fn daily_send(mut self, value: CreateRequestRssOptsScheduleDailySend) -> Self {
    ...
    pub fn weekly_send_day(mut self, value: CreateRequestRssOptsScheduleWeeklySendDay) -> Self {
        self.weekly_send_day = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CreateRequestRssOptsSchedule`].
    pub fn build(self) -> Result<CreateRequestRssOptsSchedule, BuildError> {
        Ok(CreateRequestRssOptsSchedule {
