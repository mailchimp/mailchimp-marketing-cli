...
pub enum ListSegmentMembersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSegmentMembersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSegmentMembersResponseLinksItemMethod {
...
impl fmt::Display for ListSegmentMembersResponseLinksItemMethod {
