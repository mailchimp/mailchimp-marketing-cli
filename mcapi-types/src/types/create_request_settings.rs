...
impl CreateRequestSettings {
    pub fn builder() -> CreateRequestSettingsBuilder {
        <CreateRequestSettingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateRequestSettingsBuilder {
...
impl CreateRequestSettingsBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRequestSettings`].
    pub fn build(self) -> Result<CreateRequestSettings, BuildError> {
        Ok(CreateRequestSettings {
