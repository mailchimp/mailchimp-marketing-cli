...
pub enum UpdateInterestCategoryRequestType {
    Checkboxes,
    Dropdown,
    Radio,
    Hidden,
...
impl Serialize for UpdateInterestCategoryRequestType {
...
impl<'de> Deserialize<'de> for UpdateInterestCategoryRequestType {
...
impl fmt::Display for UpdateInterestCategoryRequestType {
