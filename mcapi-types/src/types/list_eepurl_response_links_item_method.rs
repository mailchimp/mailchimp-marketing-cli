...
pub enum ListEepurlResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEepurlResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListEepurlResponseLinksItemMethod {
...
impl fmt::Display for ListEepurlResponseLinksItemMethod {
