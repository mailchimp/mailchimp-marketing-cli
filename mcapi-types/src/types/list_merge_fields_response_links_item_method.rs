...
pub enum ListMergeFieldsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMergeFieldsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMergeFieldsResponseLinksItemMethod {
...
impl fmt::Display for ListMergeFieldsResponseLinksItemMethod {
