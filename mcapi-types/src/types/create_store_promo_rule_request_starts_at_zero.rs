...
#[serde(untagged)]
pub enum CreateStorePromoRuleRequestStartsAtZero {
        DateTime(
...
impl CreateStorePromoRuleRequestStartsAtZero {
...
impl fmt::Display for CreateStorePromoRuleRequestStartsAtZero {
