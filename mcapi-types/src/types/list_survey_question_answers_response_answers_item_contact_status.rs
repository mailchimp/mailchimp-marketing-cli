...
pub enum ListSurveyQuestionAnswersResponseAnswersItemContactStatus {
    Subscribed,
    Unsubscribed,
    NonSubscribed,
    Cleaned,
...
impl Serialize for ListSurveyQuestionAnswersResponseAnswersItemContactStatus {
...
impl<'de> Deserialize<'de> for ListSurveyQuestionAnswersResponseAnswersItemContactStatus {
...
impl fmt::Display for ListSurveyQuestionAnswersResponseAnswersItemContactStatus {
