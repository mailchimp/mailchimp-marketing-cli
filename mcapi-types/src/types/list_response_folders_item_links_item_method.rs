...
pub enum ListResponseFoldersItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListResponseFoldersItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListResponseFoldersItemLinksItemMethod {
...
impl fmt::Display for ListResponseFoldersItemLinksItemMethod {
