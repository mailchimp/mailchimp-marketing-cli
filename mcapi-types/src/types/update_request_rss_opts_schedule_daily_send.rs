...
pub struct UpdateRequestRssOptsScheduleDailySend {
...
impl UpdateRequestRssOptsScheduleDailySend {
    pub fn builder() -> UpdateRequestRssOptsScheduleDailySendBuilder {
        <UpdateRequestRssOptsScheduleDailySendBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateRequestRssOptsScheduleDailySendBuilder {
    friday: Option<bool>,
    monday: Option<bool>,
...
impl UpdateRequestRssOptsScheduleDailySendBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateRequestRssOptsScheduleDailySend`].
    pub fn build(self) -> Result<UpdateRequestRssOptsScheduleDailySend, BuildError> {
        Ok(UpdateRequestRssOptsScheduleDailySend {
            friday: self.friday,
            monday: self.monday,
