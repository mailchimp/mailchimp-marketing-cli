...
pub enum CreateStorePromoRuleRequestTarget {
    PerItem,
    Total,
    Shipping,
...
impl Serialize for CreateStorePromoRuleRequestTarget {
...
impl<'de> Deserialize<'de> for CreateStorePromoRuleRequestTarget {
...
impl fmt::Display for CreateStorePromoRuleRequestTarget {
