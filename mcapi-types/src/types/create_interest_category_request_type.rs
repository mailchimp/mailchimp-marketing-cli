...
pub enum CreateInterestCategoryRequestType {
    Checkboxes,
    Dropdown,
    Radio,
    Hidden,
...
impl Serialize for CreateInterestCategoryRequestType {
...
impl<'de> Deserialize<'de> for CreateInterestCategoryRequestType {
...
impl fmt::Display for CreateInterestCategoryRequestType {
