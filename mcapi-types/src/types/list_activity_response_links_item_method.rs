...
pub enum ListActivityResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListActivityResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListActivityResponseLinksItemMethod {
...
impl fmt::Display for ListActivityResponseLinksItemMethod {
