...
pub enum ListStoreCartsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCartsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCartsResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCartsResponseLinksItemMethod {
