...
pub enum ListInterestCategoriesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListInterestCategoriesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListInterestCategoriesResponseLinksItemMethod {
...
impl fmt::Display for ListInterestCategoriesResponseLinksItemMethod {
