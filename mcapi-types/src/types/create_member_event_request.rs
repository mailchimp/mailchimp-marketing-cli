...
pub struct CreateMemberEventRequest {
...
impl CreateMemberEventRequest {
    pub fn builder() -> CreateMemberEventRequestBuilder {
        <CreateMemberEventRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateMemberEventRequestBuilder {
...
impl CreateMemberEventRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateMemberEventRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](CreateMemberEventRequestBuilder::name)
    pub fn build(self) -> Result<CreateMemberEventRequest, BuildError> {
        Ok(CreateMemberEventRequest {
