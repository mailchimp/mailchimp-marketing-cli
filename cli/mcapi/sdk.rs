...
pub fn client(ctx: &AppContext) -> mcapi_sdk::api::ApiClient {
    ...
    mcapi_sdk::api::ApiClient {
        config,
        root: mcapi_sdk::api::RootClient { http_client: http_client.clone() },
        account_exports: mcapi_sdk::api::AccountExportsClient { http_client: http_client.clone() },
        activity_feed: mcapi_sdk::api::ActivityFeedClient { http_client: http_client.clone() },
        authorized_apps: mcapi_sdk::api::AuthorizedAppsClient { http_client: http_client.clone() },
        automations: mcapi_sdk::api::AutomationsClient { http_client: http_client.clone() },
        batch_webhooks: mcapi_sdk::api::BatchWebhooksClient { http_client: http_client.clone() },
        batches: mcapi_sdk::api::BatchesClient { http_client: http_client.clone() },
        campaign_folders: mcapi_sdk::api::CampaignFoldersClient { http_client: http_client.clone() },
        campaigns: mcapi_sdk::api::CampaignsClient { http_client: http_client.clone() },
        connected_sites: mcapi_sdk::api::ConnectedSitesClient { http_client: http_client.clone() },
        conversations: mcapi_sdk::api::ConversationsClient { http_client: http_client.clone() },
        customer_journeys: mcapi_sdk::api::CustomerJourneysClient { http_client: http_client.clone() },
        ecommerce: mcapi_sdk::api::EcommerceClient { http_client: http_client.clone() },
        facebook_ads: mcapi_sdk::api::FacebookAdsClient { http_client: http_client.clone() },
        file_manager: mcapi_sdk::api::FileManagerClient { http_client: http_client.clone() },
        landing_pages: mcapi_sdk::api::LandingPagesClient { http_client: http_client.clone() },
        lists: mcapi_sdk::api::ListsClient { http_client: http_client.clone() },
        surveys: mcapi_sdk::api::SurveysClient { http_client: http_client.clone() },
        ping: mcapi_sdk::api::PingClient { http_client: http_client.clone() },
        reporting: mcapi_sdk::api::ReportingClient { http_client: http_client.clone() },
        reports: mcapi_sdk::api::ReportsClient { http_client: http_client.clone() },
        search_campaigns: mcapi_sdk::api::SearchCampaignsClient { http_client: http_client.clone() },
        sms_campaigns: mcapi_sdk::api::SmsCampaignsClient { http_client: http_client.clone() },
        search_members: mcapi_sdk::api::SearchMembersClient { http_client: http_client.clone() },
        template_folders: mcapi_sdk::api::TemplateFoldersClient { http_client: http_client.clone() },
        templates: mcapi_sdk::api::TemplatesClient { http_client: http_client.clone() },
        verified_domains: mcapi_sdk::api::VerifiedDomainsClient { http_client: http_client.clone() },
    }
}
