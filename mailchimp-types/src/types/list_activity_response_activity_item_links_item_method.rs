...
pub enum ListActivityResponseActivityItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListActivityResponseActivityItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListActivityResponseActivityItemLinksItemMethod {
...
impl fmt::Display for ListActivityResponseActivityItemLinksItemMethod {
