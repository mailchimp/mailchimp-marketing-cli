...
pub enum UpdateStoreProductImageResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateStoreProductImageResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateStoreProductImageResponseLinksItemMethod {
...
impl fmt::Display for UpdateStoreProductImageResponseLinksItemMethod {
