...
pub enum CreateStorePromoRuleRequestEndsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for CreateStorePromoRuleRequestEndsAtOne {
...
impl<'de> Deserialize<'de> for CreateStorePromoRuleRequestEndsAtOne {
...
impl fmt::Display for CreateStorePromoRuleRequestEndsAtOne {
