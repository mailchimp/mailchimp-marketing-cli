...
pub enum ListEmailsResponseLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailsResponseLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailsResponseLinksItemItemMethod {
...
impl fmt::Display for ListEmailsResponseLinksItemItemMethod {
