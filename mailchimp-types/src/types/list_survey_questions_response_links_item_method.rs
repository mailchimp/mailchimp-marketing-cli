...
pub enum ListSurveyQuestionsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveyQuestionsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveyQuestionsResponseLinksItemMethod {
...
impl fmt::Display for ListSurveyQuestionsResponseLinksItemMethod {
