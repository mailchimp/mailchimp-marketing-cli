...
pub enum ListGrowthHistoryResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListGrowthHistoryResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListGrowthHistoryResponseLinksItemMethod {
...
impl fmt::Display for ListGrowthHistoryResponseLinksItemMethod {
