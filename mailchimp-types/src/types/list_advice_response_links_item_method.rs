...
pub enum ListAdviceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAdviceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAdviceResponseLinksItemMethod {
...
impl fmt::Display for ListAdviceResponseLinksItemMethod {
