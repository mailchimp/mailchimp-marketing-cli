...
pub enum ListMemberNotesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberNotesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberNotesResponseLinksItemMethod {
...
impl fmt::Display for ListMemberNotesResponseLinksItemMethod {
