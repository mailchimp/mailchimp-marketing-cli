...
pub struct ListFilesQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_field: Option<ListFilesRequestSortField>,
    /// Determines the order direction for sorted results.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_dir: Option<ListFilesRequestSortDir>,
}
...
pub struct ListFilesQueryRequestBuilder {
    ...
    sort_field: Option<ListFilesRequestSortField>,
    sort_dir: Option<ListFilesRequestSortDir>,
}
...
impl ListFilesQueryRequestBuilder {
    ...
    pub fn sort_field(mut self, value: ListFilesRequestSortField) -> Self {
        self.sort_field = Some(value);
        self
    }

    pub fn sort_dir(mut self, value: ListFilesRequestSortDir) -> Self {
