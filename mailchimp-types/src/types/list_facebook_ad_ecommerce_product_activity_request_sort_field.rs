...
pub enum ListFacebookAdEcommerceProductActivityRequestSortField {
    Title,
    TotalRevenue,
    TotalPurchased,
...
impl Serialize for ListFacebookAdEcommerceProductActivityRequestSortField {
...
impl<'de> Deserialize<'de> for ListFacebookAdEcommerceProductActivityRequestSortField {
...
impl fmt::Display for ListFacebookAdEcommerceProductActivityRequestSortField {
