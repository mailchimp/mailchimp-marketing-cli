...
pub enum ListEcommerceProductActivityResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEcommerceProductActivityResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListEcommerceProductActivityResponseLinksItemMethod {
...
impl fmt::Display for ListEcommerceProductActivityResponseLinksItemMethod {
