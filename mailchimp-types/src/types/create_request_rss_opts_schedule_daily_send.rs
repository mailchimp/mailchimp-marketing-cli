...
pub struct CreateRequestRssOptsScheduleDailySend {
...
impl CreateRequestRssOptsScheduleDailySend {
    pub fn builder() -> CreateRequestRssOptsScheduleDailySendBuilder {
        <CreateRequestRssOptsScheduleDailySendBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateRequestRssOptsScheduleDailySendBuilder {
    friday: Option<bool>,
    monday: Option<bool>,
...
impl CreateRequestRssOptsScheduleDailySendBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRequestRssOptsScheduleDailySend`].
    pub fn build(self) -> Result<CreateRequestRssOptsScheduleDailySend, BuildError> {
        Ok(CreateRequestRssOptsScheduleDailySend {
            friday: self.friday,
            monday: self.monday,
