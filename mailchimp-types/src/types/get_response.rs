...
pub struct GetResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<GetResponseStatus>,
...
impl GetResponse {
    pub fn builder() -> GetResponseBuilder {
        <GetResponseBuilder as Default>::default()
    }
}
...
pub struct GetResponseBuilder {
    ...
    status: Option<GetResponseStatus>,
...
impl GetResponseBuilder {
    ...
    pub fn status(mut self, value: GetResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`GetResponse`].
    pub fn build(self) -> Result<GetResponse, BuildError> {
        Ok(GetResponse {
