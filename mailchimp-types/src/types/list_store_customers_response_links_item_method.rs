...
pub enum ListStoreCustomersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCustomersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCustomersResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCustomersResponseLinksItemMethod {
