...
pub struct UpdateStoreOrderRequest {
    /// The billing address for the order.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<UpdateStoreOrderRequestBillingAddress>,
    /// A string that uniquely identifies the campaign associated with an order.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub campaign_id: Option<String>,
    /// A cart id that the order was placed for.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cart_id: Option<UpdateStoreOrderRequestCartId>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub discount_total: Option<UpdateStoreOrderRequestDiscountTotal>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub lines: Option<Vec<UpdateStoreOrderRequestLinesItem>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_total: Option<UpdateStoreOrderRequestOrderTotal>,
    /// The URL for the order.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_url: Option<String>,
    /// The outreach associated with this order. For example, an email campaign or Facebook ad.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub outreach: Option<UpdateStoreOrderRequestOutreach>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub promos: Option<Vec<UpdateStoreOrderRequestPromosItem>>,
    /// The shipping address for the order.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shipping_address: Option<UpdateStoreOrderRequestShippingAddress>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shipping_total: Option<UpdateStoreOrderRequestShippingTotal>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tax_total: Option<UpdateStoreOrderRequestTaxTotal>,
    /// The tracking carrier associated with the order.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tracking_carrier: Option<String>,
    /// The Mailchimp tracking code for the order. Uses the 'mc_tc' parameter in E-Commerce tracking URLs.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tracking_code: Option<UpdateStoreOrderRequestTrackingCode>,
...
impl UpdateStoreOrderRequest {
    pub fn builder() -> UpdateStoreOrderRequestBuilder {
        <UpdateStoreOrderRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateStoreOrderRequestBuilder {
    billing_address: Option<UpdateStoreOrderRequestBillingAddress>,
    campaign_id: Option<String>,
    cart_id: Option<UpdateStoreOrderRequestCartId>,
    cancelled_at_foreign: Option<String>,
    currency_code: Option<String>,
    customer: Option<EcommerceStoresCartsPatch>,
    discount_total: Option<UpdateStoreOrderRequestDiscountTotal>,
    financial_status: Option<String>,
    fulfillment_status: Option<String>,
    id: Option<String>,
    landing_site: Option<String>,
    lines: Option<Vec<UpdateStoreOrderRequestLinesItem>>,
    order_total: Option<UpdateStoreOrderRequestOrderTotal>,
    order_url: Option<String>,
    outreach: Option<UpdateStoreOrderRequestOutreach>,
    processed_at_foreign: Option<String>,
    promos: Option<Vec<UpdateStoreOrderRequestPromosItem>>,
    shipping_address: Option<UpdateStoreOrderRequestShippingAddress>,
    shipping_total: Option<UpdateStoreOrderRequestShippingTotal>,
    tax_total: Option<UpdateStoreOrderRequestTaxTotal>,
    tracking_carrier: Option<String>,
    tracking_code: Option<UpdateStoreOrderRequestTrackingCode>,
    tracking_number: Option<String>,
    tracking_url: Option<String>,
    updated_at_foreign: Option<String>,
}

impl UpdateStoreOrderRequestBuilder {
    pub fn billing_address(mut self, value: UpdateStoreOrderRequestBillingAddress) -> Self {
    ...
    pub fn cart_id(mut self, value: UpdateStoreOrderRequestCartId) -> Self {
    ...
    pub fn discount_total(mut self, value: UpdateStoreOrderRequestDiscountTotal) -> Self {
    ...
    pub fn lines(mut self, value: Vec<UpdateStoreOrderRequestLinesItem>) -> Self {
        self.lines = Some(value);
        self
    }

    pub fn order_total(mut self, value: UpdateStoreOrderRequestOrderTotal) -> Self {
    ...
    pub fn outreach(mut self, value: UpdateStoreOrderRequestOutreach) -> Self {
    ...
    pub fn promos(mut self, value: Vec<UpdateStoreOrderRequestPromosItem>) -> Self {
        self.promos = Some(value);
        self
    }

    pub fn shipping_address(mut self, value: UpdateStoreOrderRequestShippingAddress) -> Self {
        self.shipping_address = Some(value);
        self
    }

    pub fn shipping_total(mut self, value: UpdateStoreOrderRequestShippingTotal) -> Self {
        self.shipping_total = Some(value);
        self
    }

    pub fn tax_total(mut self, value: UpdateStoreOrderRequestTaxTotal) -> Self {
    ...
    pub fn tracking_code(mut self, value: UpdateStoreOrderRequestTrackingCode) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateStoreOrderRequest`].
    pub fn build(self) -> Result<UpdateStoreOrderRequest, BuildError> {
        Ok(UpdateStoreOrderRequest {
