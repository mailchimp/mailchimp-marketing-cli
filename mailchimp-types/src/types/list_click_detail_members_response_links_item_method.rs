...
pub enum ListClickDetailMembersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListClickDetailMembersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListClickDetailMembersResponseLinksItemMethod {
...
impl fmt::Display for ListClickDetailMembersResponseLinksItemMethod {
