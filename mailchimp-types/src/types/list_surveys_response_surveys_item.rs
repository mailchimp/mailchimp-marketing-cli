...
pub struct ListSurveysResponseSurveysItem {
    ...
    /// The survey's status.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListSurveysResponseSurveysItemStatus>,
...
impl ListSurveysResponseSurveysItem {
    pub fn builder() -> ListSurveysResponseSurveysItemBuilder {
        <ListSurveysResponseSurveysItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListSurveysResponseSurveysItemBuilder {
    created_at: Option<DateTime<FixedOffset>>,
    id: Option<String>,
    list_id: Option<String>,
    list_name: Option<String>,
    published_at: Option<DateTime<FixedOffset>>,
    status: Option<ListSurveysResponseSurveysItemStatus>,
    title: Option<String>,
...
impl ListSurveysResponseSurveysItemBuilder {
    ...
    pub fn status(mut self, value: ListSurveysResponseSurveysItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListSurveysResponseSurveysItem`].
    pub fn build(self) -> Result<ListSurveysResponseSurveysItem, BuildError> {
        Ok(ListSurveysResponseSurveysItem {
