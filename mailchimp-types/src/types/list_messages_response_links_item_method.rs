...
pub enum ListMessagesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMessagesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMessagesResponseLinksItemMethod {
...
impl fmt::Display for ListMessagesResponseLinksItemMethod {
