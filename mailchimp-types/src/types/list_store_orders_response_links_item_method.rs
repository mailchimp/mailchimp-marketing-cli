...
pub enum ListStoreOrdersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreOrdersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreOrdersResponseLinksItemMethod {
...
impl fmt::Display for ListStoreOrdersResponseLinksItemMethod {
