...
pub struct ListLocationsResponseLocationsItem {
...
impl ListLocationsResponseLocationsItem {
    pub fn builder() -> ListLocationsResponseLocationsItemBuilder {
        <ListLocationsResponseLocationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListLocationsResponseLocationsItemBuilder {
...
impl ListLocationsResponseLocationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListLocationsResponseLocationsItem`].
    pub fn build(self) -> Result<ListLocationsResponseLocationsItem, BuildError> {
        Ok(ListLocationsResponseLocationsItem {
