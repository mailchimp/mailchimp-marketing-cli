...
pub enum ListMemberActivityResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberActivityResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberActivityResponseLinksItemMethod {
...
impl fmt::Display for ListMemberActivityResponseLinksItemMethod {
