...
pub enum CreateRequestRssOptsScheduleWeeklySendDay {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for CreateRequestRssOptsScheduleWeeklySendDay {
...
impl<'de> Deserialize<'de> for CreateRequestRssOptsScheduleWeeklySendDay {
...
impl fmt::Display for CreateRequestRssOptsScheduleWeeklySendDay {
