...
pub enum ListFoldersResponseFoldersItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFoldersResponseFoldersItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFoldersResponseFoldersItemLinksItemMethod {
...
impl fmt::Display for ListFoldersResponseFoldersItemLinksItemMethod {
