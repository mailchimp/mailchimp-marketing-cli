...
pub struct BatchSubscribeOrUnsubscribeRequest {
    ...
    #[serde(default)]
    pub members: Vec<BatchSubscribeOrUnsubscribeRequestMembersItem>,
...
impl BatchSubscribeOrUnsubscribeRequest {
    pub fn builder() -> BatchSubscribeOrUnsubscribeRequestBuilder {
        <BatchSubscribeOrUnsubscribeRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BatchSubscribeOrUnsubscribeRequestBuilder {
    members: Option<Vec<BatchSubscribeOrUnsubscribeRequestMembersItem>>,
...
impl BatchSubscribeOrUnsubscribeRequestBuilder {
    pub fn members(mut self, value: Vec<BatchSubscribeOrUnsubscribeRequestMembersItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`BatchSubscribeOrUnsubscribeRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`members`](BatchSubscribeOrUnsubscribeRequestBuilder::members)
    pub fn build(self) -> Result<BatchSubscribeOrUnsubscribeRequest, BuildError> {
        Ok(BatchSubscribeOrUnsubscribeRequest {
