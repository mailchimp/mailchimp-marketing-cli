...
#[serde(untagged)]
pub enum UpdateRequestVariateSettingsSendTimesItem {
        DateTime(
...
impl UpdateRequestVariateSettingsSendTimesItem {
...
impl fmt::Display for UpdateRequestVariateSettingsSendTimesItem {
