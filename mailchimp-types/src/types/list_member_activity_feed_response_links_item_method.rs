...
pub enum ListMemberActivityFeedResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberActivityFeedResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberActivityFeedResponseLinksItemMethod {
...
impl fmt::Display for ListMemberActivityFeedResponseLinksItemMethod {
