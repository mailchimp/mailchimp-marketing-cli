...
#[serde(untagged)]
pub enum UpdateStorePromoRuleRequestStartsAtZero {
        DateTime(
...
impl UpdateStorePromoRuleRequestStartsAtZero {
...
impl fmt::Display for UpdateStorePromoRuleRequestStartsAtZero {
