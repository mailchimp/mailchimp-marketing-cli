...
pub struct GetSurveyResponsResponseContact {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<GetSurveyResponsResponseContactStatus>,
}

impl GetSurveyResponsResponseContact {
    pub fn builder() -> GetSurveyResponsResponseContactBuilder {
        <GetSurveyResponsResponseContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetSurveyResponsResponseContactBuilder {
    ...
    phone: Option<String>,
    status: Option<GetSurveyResponsResponseContactStatus>,
}

impl GetSurveyResponsResponseContactBuilder {
    ...
    pub fn status(mut self, value: GetSurveyResponsResponseContactStatus) -> Self {
        self.status = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`GetSurveyResponsResponseContact`].
    pub fn build(self) -> Result<GetSurveyResponsResponseContact, BuildError> {
        Ok(GetSurveyResponsResponseContact {
