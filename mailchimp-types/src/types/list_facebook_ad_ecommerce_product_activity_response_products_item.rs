...
pub struct ListFacebookAdEcommerceProductActivityResponseProductsItem {
...
impl ListFacebookAdEcommerceProductActivityResponseProductsItem {
    pub fn builder() -> ListFacebookAdEcommerceProductActivityResponseProductsItemBuilder {
        <ListFacebookAdEcommerceProductActivityResponseProductsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListFacebookAdEcommerceProductActivityResponseProductsItemBuilder {
...
impl ListFacebookAdEcommerceProductActivityResponseProductsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListFacebookAdEcommerceProductActivityResponseProductsItem`].
    pub fn build(self) -> Result<ListFacebookAdEcommerceProductActivityResponseProductsItem, BuildError> {
        Ok(ListFacebookAdEcommerceProductActivityResponseProductsItem {
