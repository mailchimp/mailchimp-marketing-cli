...
pub enum ListClientsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListClientsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListClientsResponseLinksItemMethod {
...
impl fmt::Display for ListClientsResponseLinksItemMethod {
