...
pub enum ListStoresResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoresResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoresResponseLinksItemMethod {
...
impl fmt::Display for ListStoresResponseLinksItemMethod {
