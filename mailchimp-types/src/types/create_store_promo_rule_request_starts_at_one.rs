...
pub enum CreateStorePromoRuleRequestStartsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for CreateStorePromoRuleRequestStartsAtOne {
...
impl<'de> Deserialize<'de> for CreateStorePromoRuleRequestStartsAtOne {
...
impl fmt::Display for CreateStorePromoRuleRequestStartsAtOne {
