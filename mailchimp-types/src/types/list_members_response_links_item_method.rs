...
pub enum ListMembersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMembersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMembersResponseLinksItemMethod {
...
impl fmt::Display for ListMembersResponseLinksItemMethod {
