...
pub enum ListChimpChatterResponseChimpChatterItemType {
    ListsNewSubscriber,
    ListsUnsubscribes,
    ListsProfileUpdates,
...
impl Serialize for ListChimpChatterResponseChimpChatterItemType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            Self::CampaignsForwardToFriend => serializer.serialize_str("campaigns:forward-to-friend"),
...
impl<'de> Deserialize<'de> for ListChimpChatterResponseChimpChatterItemType {
...
impl fmt::Display for ListChimpChatterResponseChimpChatterItemType {
