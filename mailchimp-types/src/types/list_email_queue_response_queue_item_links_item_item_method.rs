...
pub enum ListEmailQueueResponseQueueItemLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailQueueResponseQueueItemLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailQueueResponseQueueItemLinksItemItemMethod {
...
impl fmt::Display for ListEmailQueueResponseQueueItemLinksItemItemMethod {
