...
pub struct ListResponseContact {
...
impl ListResponseContact {
    pub fn builder() -> ListResponseContactBuilder {
        <ListResponseContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListResponseContactBuilder {
    addr1: Option<String>,
    addr2: Option<String>,
    city: Option<String>,
...
impl ListResponseContactBuilder {
    ...
    /// Consumes the builder and constructs a [`ListResponseContact`].
    pub fn build(self) -> Result<ListResponseContact, BuildError> {
        Ok(ListResponseContact {
            addr1: self.addr1,
            addr2: self.addr2,
            city: self.city,
