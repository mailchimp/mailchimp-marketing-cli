...
pub enum ListOrdersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListOrdersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListOrdersResponseLinksItemMethod {
...
impl fmt::Display for ListOrdersResponseLinksItemMethod {
