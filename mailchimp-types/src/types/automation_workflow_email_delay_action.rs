...
impl Serialize for AutomationWorkflowEmailDelayAction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match self {
            ...
            Self::PreviousCampaignNotOpened => serializer.serialize_str("previous_campaign_not_opened"),
            Self::PreviousCampaignClickedAny => serializer.serialize_str("previous_campaign_clicked_any"),
            Self::PreviousCampaignNotClickedAny => serializer.serialize_str("previous_campaign_not_clicked_any"),
            Self::PreviousCampaignSpecificClicked => serializer.serialize_str("previous_campaign_specific_clicked"),
...
impl fmt::Display for AutomationWorkflowEmailDelayAction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::PreviousCampaignSpecificClicked => write!(f, "previous_campaign_specific_clicked"),
