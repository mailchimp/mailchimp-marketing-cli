...
pub enum UpsertMemberRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpsertMemberRequestStatus {
...
impl<'de> Deserialize<'de> for UpsertMemberRequestStatus {
...
impl fmt::Display for UpsertMemberRequestStatus {
