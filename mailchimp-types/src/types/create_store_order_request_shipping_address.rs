...
pub struct CreateStoreOrderRequestShippingAddress {
    /// The shipping address for the order.
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub latitude: Option<CreateStoreOrderRequestShippingAddressLatitude>,
    /// The longitude for the shipping address location.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub longitude: Option<CreateStoreOrderRequestShippingAddressLongitude>,
...
impl CreateStoreOrderRequestShippingAddress {
    pub fn builder() -> CreateStoreOrderRequestShippingAddressBuilder {
        <CreateStoreOrderRequestShippingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateStoreOrderRequestShippingAddressBuilder {
    ...
    latitude: Option<CreateStoreOrderRequestShippingAddressLatitude>,
    longitude: Option<CreateStoreOrderRequestShippingAddressLongitude>,
    name: Option<String>,
    phone: Option<String>,
...
impl CreateStoreOrderRequestShippingAddressBuilder {
    ...
    pub fn latitude(mut self, value: CreateStoreOrderRequestShippingAddressLatitude) -> Self {
        self.latitude = Some(value);
        self
    }

    pub fn longitude(mut self, value: CreateStoreOrderRequestShippingAddressLongitude) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateStoreOrderRequestShippingAddress`].
    pub fn build(self) -> Result<CreateStoreOrderRequestShippingAddress, BuildError> {
        Ok(CreateStoreOrderRequestShippingAddress {
