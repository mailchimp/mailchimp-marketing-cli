...
pub struct UpdateStoreRequest {
    ...
    pub address: Option<UpdateStoreRequestAddress>,
...
impl UpdateStoreRequest {
    pub fn builder() -> UpdateStoreRequestBuilder {
        <UpdateStoreRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateStoreRequestBuilder {
    address: Option<UpdateStoreRequestAddress>,
...
impl UpdateStoreRequestBuilder {
    pub fn address(mut self, value: UpdateStoreRequestAddress) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateStoreRequest`].
    pub fn build(self) -> Result<UpdateStoreRequest, BuildError> {
