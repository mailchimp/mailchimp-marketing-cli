...
pub struct ListFacebookAdEcommerceProductActivityQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_field: Option<ListFacebookAdEcommerceProductActivityRequestSortField>,
}
...
pub struct ListFacebookAdEcommerceProductActivityQueryRequestBuilder {
    ...
    count: Option<i64>,
    offset: Option<i64>,
    sort_field: Option<ListFacebookAdEcommerceProductActivityRequestSortField>,
}
...
impl ListFacebookAdEcommerceProductActivityQueryRequestBuilder {
    ...
    pub fn sort_field(mut self, value: ListFacebookAdEcommerceProductActivityRequestSortField) -> Self {
