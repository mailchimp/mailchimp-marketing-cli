...
pub enum GetSurveyResponsResponseResultsItemQuestionType {
    PickOne,
    PickMany,
    Range,
    Text,
...
impl Serialize for GetSurveyResponsResponseResultsItemQuestionType {
...
impl<'de> Deserialize<'de> for GetSurveyResponsResponseResultsItemQuestionType {
...
impl fmt::Display for GetSurveyResponsResponseResultsItemQuestionType {
