...
pub enum ListFilesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFilesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFilesResponseLinksItemMethod {
...
impl fmt::Display for ListFilesResponseLinksItemMethod {
