...
pub enum ListWebhooksResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListWebhooksResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListWebhooksResponseLinksItemMethod {
...
impl fmt::Display for ListWebhooksResponseLinksItemMethod {
