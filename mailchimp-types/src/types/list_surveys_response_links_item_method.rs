...
pub enum ListSurveysResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveysResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveysResponseLinksItemMethod {
...
impl fmt::Display for ListSurveysResponseLinksItemMethod {
