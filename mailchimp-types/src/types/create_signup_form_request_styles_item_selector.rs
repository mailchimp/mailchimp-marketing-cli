...
pub enum CreateSignupFormRequestStylesItemSelector {
    PageBackground,
    PageHeader,
    PageOuterWrapper,
    BodyBackground,
...
impl Serialize for CreateSignupFormRequestStylesItemSelector {
...
impl<'de> Deserialize<'de> for CreateSignupFormRequestStylesItemSelector {
...
impl fmt::Display for CreateSignupFormRequestStylesItemSelector {
