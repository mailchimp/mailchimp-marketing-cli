...
pub enum CreateMergeFieldRequestType {
    Text,
    Number,
    Address,
    Phone,
...
impl Serialize for CreateMergeFieldRequestType {
...
impl<'de> Deserialize<'de> for CreateMergeFieldRequestType {
...
impl fmt::Display for CreateMergeFieldRequestType {
