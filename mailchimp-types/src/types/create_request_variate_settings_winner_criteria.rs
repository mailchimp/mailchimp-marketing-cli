...
pub enum CreateRequestVariateSettingsWinnerCriteria {
    Opens,
    Clicks,
    Manual,
    TotalRevenue,
...
impl Serialize for CreateRequestVariateSettingsWinnerCriteria {
...
impl<'de> Deserialize<'de> for CreateRequestVariateSettingsWinnerCriteria {
...
impl fmt::Display for CreateRequestVariateSettingsWinnerCriteria {
