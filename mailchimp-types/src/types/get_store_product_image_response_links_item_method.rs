...
pub enum GetStoreProductImageResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetStoreProductImageResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetStoreProductImageResponseLinksItemMethod {
...
impl fmt::Display for GetStoreProductImageResponseLinksItemMethod {
