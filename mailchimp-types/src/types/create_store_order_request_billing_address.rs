...
pub struct CreateStoreOrderRequestBillingAddress {
    /// The billing address for the order.
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub latitude: Option<CreateStoreOrderRequestBillingAddressLatitude>,
    /// The longitude for the billing address location.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub longitude: Option<CreateStoreOrderRequestBillingAddressLongitude>,
...
impl CreateStoreOrderRequestBillingAddress {
    pub fn builder() -> CreateStoreOrderRequestBillingAddressBuilder {
        <CreateStoreOrderRequestBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateStoreOrderRequestBillingAddressBuilder {
    ...
    latitude: Option<CreateStoreOrderRequestBillingAddressLatitude>,
    longitude: Option<CreateStoreOrderRequestBillingAddressLongitude>,
    name: Option<String>,
    phone: Option<String>,
...
impl CreateStoreOrderRequestBillingAddressBuilder {
    ...
    pub fn latitude(mut self, value: CreateStoreOrderRequestBillingAddressLatitude) -> Self {
        self.latitude = Some(value);
        self
    }

    pub fn longitude(mut self, value: CreateStoreOrderRequestBillingAddressLongitude) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateStoreOrderRequestBillingAddress`].
    pub fn build(self) -> Result<CreateStoreOrderRequestBillingAddress, BuildError> {
        Ok(CreateStoreOrderRequestBillingAddress {
