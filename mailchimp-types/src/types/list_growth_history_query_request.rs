...
pub struct ListGrowthHistoryQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_field: Option<ListGrowthHistoryRequestSortField>,
    /// Determines the order direction for sorted results.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_dir: Option<ListGrowthHistoryRequestSortDir>,
}
...
pub struct ListGrowthHistoryQueryRequestBuilder {
    ...
    count: Option<i64>,
    offset: Option<i64>,
    sort_field: Option<ListGrowthHistoryRequestSortField>,
    sort_dir: Option<ListGrowthHistoryRequestSortDir>,
}
...
impl ListGrowthHistoryQueryRequestBuilder {
    ...
    pub fn sort_field(mut self, value: ListGrowthHistoryRequestSortField) -> Self {
        self.sort_field = Some(value);
        self
    }

    pub fn sort_dir(mut self, value: ListGrowthHistoryRequestSortDir) -> Self {
