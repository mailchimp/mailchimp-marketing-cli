...
pub enum ListEmailActivityResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailActivityResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailActivityResponseLinksItemMethod {
...
impl fmt::Display for ListEmailActivityResponseLinksItemMethod {
