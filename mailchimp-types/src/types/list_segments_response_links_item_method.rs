...
pub enum ListSegmentsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSegmentsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSegmentsResponseLinksItemMethod {
...
impl fmt::Display for ListSegmentsResponseLinksItemMethod {
