...
pub enum ListResponseItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListResponseItemMethod {
...
impl<'de> Deserialize<'de> for ListResponseItemMethod {
...
impl fmt::Display for ListResponseItemMethod {
