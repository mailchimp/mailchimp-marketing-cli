...
pub enum CreateRequestOperationsItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateRequestOperationsItemMethod {
...
impl<'de> Deserialize<'de> for CreateRequestOperationsItemMethod {
...
impl fmt::Display for CreateRequestOperationsItemMethod {
