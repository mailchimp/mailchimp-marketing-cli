...
pub enum ListSurveyResponsesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveyResponsesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveyResponsesResponseLinksItemMethod {
...
impl fmt::Display for ListSurveyResponsesResponseLinksItemMethod {
