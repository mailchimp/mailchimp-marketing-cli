...
pub enum ListChimpChatterResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListChimpChatterResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListChimpChatterResponseLinksItemMethod {
...
impl fmt::Display for ListChimpChatterResponseLinksItemMethod {
