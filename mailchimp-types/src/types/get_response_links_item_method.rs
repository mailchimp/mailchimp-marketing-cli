...
pub enum GetResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetResponseLinksItemMethod {
...
impl fmt::Display for GetResponseLinksItemMethod {
