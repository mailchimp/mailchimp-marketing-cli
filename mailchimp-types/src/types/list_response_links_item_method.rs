...
pub enum ListResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListResponseLinksItemMethod {
...
impl fmt::Display for ListResponseLinksItemMethod {
