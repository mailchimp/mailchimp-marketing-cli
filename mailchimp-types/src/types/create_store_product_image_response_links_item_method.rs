...
pub enum CreateStoreProductImageResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateStoreProductImageResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateStoreProductImageResponseLinksItemMethod {
...
impl fmt::Display for CreateStoreProductImageResponseLinksItemMethod {
