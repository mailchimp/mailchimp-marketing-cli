...
pub enum ListOpenDetailsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListOpenDetailsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListOpenDetailsResponseLinksItemMethod {
...
impl fmt::Display for ListOpenDetailsResponseLinksItemMethod {
