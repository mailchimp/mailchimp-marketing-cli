...
pub struct ListMemberActivityFeedQueryRequest {
    ...
    #[serde(default)]
    pub activity_filters: Vec<Option<ListMemberActivityFeedRequestActivityFiltersItem>>,
}
...
pub struct ListMemberActivityFeedQueryRequestBuilder {
    ...
    count: Option<i64>,
    offset: Option<i64>,
    activity_filters: Option<Vec<Option<ListMemberActivityFeedRequestActivityFiltersItem>>>,
}
...
impl ListMemberActivityFeedQueryRequestBuilder {
    ...
    pub fn activity_filters(mut self, value: Vec<Option<ListMemberActivityFeedRequestActivityFiltersItem>>) -> Self {
    ...
    pub fn build(self) -> Result<ListMemberActivityFeedQueryRequest, BuildError> {
        Ok(ListMemberActivityFeedQueryRequest {
            ...
            count: self.count,
            offset: self.offset,
            activity_filters: self.activity_filters.ok_or_else(|| BuildError::missing_field("activity_filters"))?,
        })
    }
}
