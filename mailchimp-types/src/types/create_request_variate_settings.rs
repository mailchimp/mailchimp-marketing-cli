...
pub struct CreateRequestVariateSettings {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub send_times: Option<Vec<CreateRequestVariateSettingsSendTimesItem>>,
    ...
    pub winner_criteria: CreateRequestVariateSettingsWinnerCriteria,
}

impl CreateRequestVariateSettings {
    pub fn builder() -> CreateRequestVariateSettingsBuilder {
        <CreateRequestVariateSettingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateRequestVariateSettingsBuilder {
    from_names: Option<Vec<String>>,
    reply_to_addresses: Option<Vec<String>>,
    send_times: Option<Vec<CreateRequestVariateSettingsSendTimesItem>>,
    subject_lines: Option<Vec<String>>,
    test_size: Option<i64>,
    wait_time: Option<i64>,
    winner_criteria: Option<CreateRequestVariateSettingsWinnerCriteria>,
}

impl CreateRequestVariateSettingsBuilder {
    ...
    pub fn send_times(mut self, value: Vec<CreateRequestVariateSettingsSendTimesItem>) -> Self {
    ...
    pub fn winner_criteria(mut self, value: CreateRequestVariateSettingsWinnerCriteria) -> Self {
        self.winner_criteria = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CreateRequestVariateSettings`].
    /// This method will fail if any of the following fields are not set:
    /// - [`winner_criteria`](CreateRequestVariateSettingsBuilder::winner_criteria)
    pub fn build(self) -> Result<CreateRequestVariateSettings, BuildError> {
        Ok(CreateRequestVariateSettings {
            ...
            winner_criteria: self.winner_criteria.ok_or_else(|| BuildError::missing_field("winner_criteria"))?,
        })
    }
}
