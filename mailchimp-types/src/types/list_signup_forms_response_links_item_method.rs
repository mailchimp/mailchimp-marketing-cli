...
pub enum ListSignupFormsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSignupFormsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSignupFormsResponseLinksItemMethod {
...
impl fmt::Display for ListSignupFormsResponseLinksItemMethod {
