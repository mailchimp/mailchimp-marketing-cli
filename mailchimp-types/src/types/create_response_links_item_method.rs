...
pub enum CreateResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateResponseLinksItemMethod {
...
impl fmt::Display for CreateResponseLinksItemMethod {
