...
pub enum ListUnsubscribedResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListUnsubscribedResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListUnsubscribedResponseLinksItemMethod {
...
impl fmt::Display for ListUnsubscribedResponseLinksItemMethod {
