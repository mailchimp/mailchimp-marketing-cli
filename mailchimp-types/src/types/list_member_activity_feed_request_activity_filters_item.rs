...
pub enum ListMemberActivityFeedRequestActivityFiltersItem {
    Bounce,
    Click,
    Conversation,
    EcommerceSignup,
...
impl Serialize for ListMemberActivityFeedRequestActivityFiltersItem {
...
impl<'de> Deserialize<'de> for ListMemberActivityFeedRequestActivityFiltersItem {
...
impl fmt::Display for ListMemberActivityFeedRequestActivityFiltersItem {
