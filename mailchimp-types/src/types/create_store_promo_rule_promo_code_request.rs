...
pub struct CreateStorePromoRulePromoCodeRequest {
...
impl CreateStorePromoRulePromoCodeRequest {
    pub fn builder() -> CreateStorePromoRulePromoCodeRequestBuilder {
        <CreateStorePromoRulePromoCodeRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateStorePromoRulePromoCodeRequestBuilder {
    code: Option<String>,
...
impl CreateStorePromoRulePromoCodeRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateStorePromoRulePromoCodeRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`code`](CreateStorePromoRulePromoCodeRequestBuilder::code)
    /// - [`id`](CreateStorePromoRulePromoCodeRequestBuilder::id)
    /// - [`redemption_url`](CreateStorePromoRulePromoCodeRequestBuilder::redemption_url)
    pub fn build(self) -> Result<CreateStorePromoRulePromoCodeRequest, BuildError> {
        Ok(CreateStorePromoRulePromoCodeRequest {
            code: self.code.ok_or_else(|| BuildError::missing_field("code"))?,
            created_at_foreign: self.created_at_foreign,
            enabled: self.enabled,
            id: self.id.ok_or_else(|| BuildError::missing_field("id"))?,
            redemption_url: self.redemption_url.ok_or_else(|| BuildError::missing_field("redemption_url"))?,
