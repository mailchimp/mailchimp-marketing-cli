...
impl ListSurveyQuestionAnswersReportingResponseAnswersItemContactBuilder {
    ...
    pub fn status(mut self, value: ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus) -> Self {
        self.status = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ListSurveyQuestionAnswersReportingResponseAnswersItemContact`].
    pub fn build(self) -> Result<ListSurveyQuestionAnswersReportingResponseAnswersItemContact, BuildError> {
        Ok(ListSurveyQuestionAnswersReportingResponseAnswersItemContact {
