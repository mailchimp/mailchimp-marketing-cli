...
impl UpdateCampaignsRequestVariateSettingsBuilder {
    ...
    pub fn send_times(mut self, value: Vec<UpdateCampaignsRequestVariateSettingsSendTimesItem>) -> Self {
    ...
    pub fn winner_criteria(mut self, value: UpdateCampaignsRequestVariateSettingsWinnerCriteria) -> Self {
