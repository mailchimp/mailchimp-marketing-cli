...
impl CreateStoreOrderEcommerceRequestBillingAddressBuilder {
    ...
    pub fn latitude(mut self, value: CreateStoreOrderEcommerceRequestBillingAddressLatitude) -> Self {
        self.latitude = Some(value);
        self
    }

    pub fn longitude(mut self, value: CreateStoreOrderEcommerceRequestBillingAddressLongitude) -> Self {
